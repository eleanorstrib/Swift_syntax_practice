...
let yourSentence = "My \(nounArray[1]) needs a new \(nounArray[7])."
let yourSillySentence = "Your \(nounArray[index1]) is really \(nounArray[index2])."
//: ### Exercise 2
...
let newShoutString = "HEY! " + didYouKnowString.uppercaseString
//: ### Exercise 3
//: How many characters are in this string? Hint: One solution starts with casting the string as an array.
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
var count1 = 0
for character in howManyCharacters {
    count1++
    println(count1)
}

let words = howManyCharacters as NSString!
...
println(lottaLikes.dynamicType)

var fewerLikes = lottaLikes.stringByReplacingOccurrencesOfString("like", withString:"")
...
var dictionary = ["monkey": "🐒", "iPhone":"📱"]
var newestString = sillyMonkeyString
var stringArray = split(newestString) {$0 == " "}
...
//: Below is the code to find all the numbers present in an array, convert them to Ints, and calculate their sum. Have a look at the entities declared below: array, sum, and intToAdd. Think about whether each should be a constant or a variable and choose whether to declare them with let or var. When you're finished uncomment the code and see if the compiler agrees with your choices!
 ...
 for String in array {
     if String.toInt() != nil {
         var intToAdd = String.toInt()! // TODO: Choose constant or variable
         sum += intToAdd
     }
 }
 println(sum)
